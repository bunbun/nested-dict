...
project = u'nested_dict'
copyright = u'2009, 2015, Leo Goodstadt'
author = u'Leo Goodstadt'
...
htmlhelp_basename = 'nested_dictdoc'
...
latex_documents = [
  (master_doc, 'nested_dict.tex', u'nested\\_dict Documentation',
...
man_pages = [
    (master_doc, 'nested_dict', u'nested_dict Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'nested_dict', u'nested_dict Documentation',
   author, 'nested_dict', 'One line description of project.',
   'Miscellaneous'),
]
