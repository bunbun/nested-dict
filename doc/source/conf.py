# -*- coding: utf-8 -*-
#
# Lab book build configuration file, created by
...
version = datetime.datetime.utcnow().strftime("%A, %x %X")
# The full version, including alpha/beta/rc tags.
release = datetime.datetime.utcnow().strftime("%A, %x %X")
...
htmlhelp_basename = 'nested_dict_doc'
...
latex_documents = [
  ('index', 'nested_dict.tex', u'nested_dict Documentation',
